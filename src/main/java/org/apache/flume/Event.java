...
public interface Event {
    /**
     * body's data type. the value can be int, long, string. null means byte[].
     */
    String bodyType = "bodyType";
    /**
     * body's data charset when body type is a string. default UTF-8.
     */
    String bodyCharset = "bodyCharset";
